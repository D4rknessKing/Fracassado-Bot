...
public enum EconomyItem {
    ...
    DEBUFF_MUTE10M("10min Mute", "Quando consumido, permite ao usuário mutar um membro da guild por 10 minutos", "⚙", 5200, true),
    DEBUFF_XP50("50%XP Debuff", "Ao ser usado em um membro da guild, diminui o ganho de XP do mesmo em 50% por 6 horas", "⚙", 2000, true),
    DEBUFF_XP100("100%XP Debuff", "Ao ser usado em um membro da guild, diminui o ganho de XP do mesmo em 100% por 6 horas", "⚙", 5200, true),
    DEBUFF_VANISH("Vanish Power", "Ao ser usado em um membro da guild, retira a cor de seu cargo por 1 hora", ":gear:", 2000, true),
    REVERSE("Reverse Card", "Caso o usuario possua esse item no inventario, quando atacado por um debuff, o debuff automaticamente será enviado de volta (Pode ser afetado por outros reverse cards)", "⚙", 15000, false),
    ...
    OWNROLE("Role Proprio", "O usuário que utilizar essa perk terá o direito de criar seu próprio cargo escolhendo qualquer nome e cor para ele. O cargo ficará disponível exclusivamente por 1 semana.", "⚙", 15000, true),
